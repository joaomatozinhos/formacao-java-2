...
class MedicoRepositoryTest {
	...
	void escolherMedicoAleatorioLivreNaDataCenario1() {
		...
		var medicoLivre = medicoRepository.escolheMedicoAleatorioLivreNaData(Especialidade.CARDIOLOGIA,
				proximaSegundaAs10);
	...
	void escolherMedicoAleatorioLivreNaDataCenario2() {
		...
		Medico medicoLivre = medicoRepository.escolheMedicoAleatorioLivreNaData(Especialidade.CARDIOLOGIA,
				proximaSegundaAs10);
